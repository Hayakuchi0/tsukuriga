...
from browse.models import Ranking, Channel, VideoProfileChannelRelation
...
class VideoProfile(CustomModel):
    ...
    channels = models.ManyToManyField(Channel, verbose_name='チャンネル', blank=True, through=VideoProfileChannelRelation)
